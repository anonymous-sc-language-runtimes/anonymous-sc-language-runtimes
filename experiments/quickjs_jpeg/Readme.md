...
```bash
cd build
./src/runtime/quickjs/quickjs_rt ../experiments/quickjs_jpeg/js/jpeg_decode_emacs.js
```

```bash
cd build
./experiments/quickjs_jpeg/quickjs_jpeg
```

Recovery:
```bash
python experiments/quickjs_jpeg/evaluation/extract_jpeg_js.py -f build/output/quickjs_jpeg_js_r00001/r0.out
```
